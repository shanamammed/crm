           ...
           <form method="post"  action="{{url('users/store')}}"> 
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1" name="name" type="text" class="form-control w-full" placeholder="User Name" required>
                ...
                <div class="mt-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="email" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="input-group-email" required>
                    </div>
                ...
                <div class="mt-3">
                    ...
                    <select data-placeholder="Select your favorite actors" class="tom-select w-full" name="roles[]" id="crud-form-2" multiple>
                ...
                <div class="mt-3">
                    ...
                    <input id="crud-form-1" name="password" type="text" class="form-control w-full" placeholder="Password" required>
