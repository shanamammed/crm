          ...
          <form method="post" action="{{url('products/store')}}">  
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1" name="name" type="text" class="form-control w-full" placeholder="Product Name" required>
                </div>  
                @error('name') <span class="error" style="color:red;">{{ $message }}</span> @enderror<br>
                <div>
                    <label for="crud-form-1" class="form-label">SKU</label>
                    <input id="crud-form-1" name="sku" type="text" class="form-control w-full" placeholder="SKU">
                </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="input-group">
                        <input id="crud-form-4" name="weight" type="text" class="form-control" placeholder="Weight" aria-describedby="input-group-2">
                ...
                <div class="mt-3">                    
                    <div class="sm:grid grid-cols-3 gap-2">
                        <div class="input-group mt-2 sm:mt-0">
                            ...
                            <input type="number" step="any" name="unit_price" class="form-control" placeholder="Unit Price" aria-describedby="input-group-4" required>
                        </div> 
                        ...
                        <div class="input-group mt-2 sm:mt-0">
                            ...
                            <input type="number" step="any" name="diret_price" class="form-control" placeholder="Direct Price" aria-describedby="input-group-5">
                        </div>
                ...
                <div class="mt-3">                  
                    <div class="sm:grid grid-cols-3 gap-2">
                        <div class="input-group mt-2 sm:mt-0">
                            ...
                            <input type="text" name="tax_rate" class="form-control" placeholder="Tax Rate" aria-describedby="input-group-4" value="10">
                        </div>
                         @error('tax_rate') <span class="error" style="color:red;">{{ $message }}</span> @enderror
                        <div class="input-group mt-2 sm:mt-0">
                            <label class="form-label">Tax label</label>&nbsp;
                            <div class="input-group">
                                <input id="crud-form-4" type="text" class="form-control" placeholder="Tax lable" name="tax_label" value="TAX" aria-describedby="input-group-2">
                            </div>
                        </div>
