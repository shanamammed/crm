          ...
          <form method="post" action="{{url('contacts/update/'.$contact->id)}}">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1" name="first_name" type="text" class="form-control w-full" placeholder="First Name" value="{{$contact->first_name}}" required>
                ...
                <div>
                    ...
                    <input id="crud-form-1" name="last_name" type="text" class="form-control w-full" placeholder="Last Name" value="{{$contact->last_name}}" required>
                ...
                <div>
                    ...
                    <input id="crud-form-2" name="email" type="text" class="form-control w-full" placeholder="Email Address" value="{{$contact->email}}" required>
                ...
                <div>
                    <label for="crud-form-2" class="form-label">Phone</label>
                     <table id="contact-phone" width="90%;">
                      ...
                      <tr>
                        <td><input type="text" class="form-control phones" name="phones[]" id="phones" value="{{$phone->mobile}}"></td>
                        <!-- <td>
                            <select>
